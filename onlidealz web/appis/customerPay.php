...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "SELECT * FROM payment where customer_id='$customer_id' order by status ASC";
    ...
    if (mysqli_num_rows($response) > 0) {
        ...
        while ($row = mysqli_fetch_array($response)) {
            ...
            $index['mpesa'] = $row['mpesa'];//orders,shipping,discount,discounted,original
        ...
        $results['trust'] = 0;
        $results['mine'] = "No Payament Found";
