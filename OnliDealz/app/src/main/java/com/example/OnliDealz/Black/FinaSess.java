...
public class FinaSess {
    private static final String preference = "Maimuna";
     ...
     */
    //reg_id,fullname,username,mobile,email,role,approval,reg_date
    public void tryFina(String reg_id, String fullname, String username, String mobile, String email,String role,
