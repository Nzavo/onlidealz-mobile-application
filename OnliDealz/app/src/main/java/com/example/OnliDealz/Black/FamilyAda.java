...
public class FamilyAda extends ArrayAdapter<CartMod> {
    public ArrayList<CartMod> MainList;
    public ArrayList<CartMod> SubjectListTemp;
    public FamilyAda.SubjectDataFilter subjectDataFilter;
    String selectedID = "";

    public FamilyAda(Context context, int id, ArrayList<CartMod> subjectArrayList) {
    ...
    public Filter getFilter() {
        ...
        if (subjectDataFilter == null) {
            ...
            subjectDataFilter = new FamilyAda.SubjectDataFilter();
        }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        FamilyAda.ViewHolder holder = null;

        if (convertView == null) {

            LayoutInflater vi = (LayoutInflater) getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = vi.inflate(R.layout.menem, null);
            holder = new FamilyAda.ViewHolder();
            ...
            holder = (FamilyAda.ViewHolder) convertView.getTag();
        }
