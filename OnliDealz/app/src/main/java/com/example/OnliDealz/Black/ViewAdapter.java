...
public class ViewAdapter extends ArrayAdapter<ProductMod> {
    public ArrayList<ProductMod> MainList;
    public ArrayList<ProductMod> SubjectListTemp;
    public ViewAdapter.SubjectDataFilter subjectDataFilter;

    public ViewAdapter(Context context, int id, ArrayList<ProductMod> subjectArrayList) {
    ...
    public Filter getFilter() {
        ...
        if (subjectDataFilter == null) {
            ...
            subjectDataFilter = new ViewAdapter.SubjectDataFilter();
        }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewAdapter.ViewHolder holder = null;
        ...
        if (convertView == null) {
            ...
            holder = (ViewAdapter.ViewHolder) convertView.getTag();
        }
        ...
        holder.review.setText("Click to View \nMore");
